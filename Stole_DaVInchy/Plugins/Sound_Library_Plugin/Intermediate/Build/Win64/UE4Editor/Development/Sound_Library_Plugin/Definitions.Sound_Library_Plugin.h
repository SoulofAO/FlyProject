#undef SOUND_LIBRARY_PLUGIN_API
...
#define UE_MODULE_NAME "Sound_Library_Plugin"
#define UE_PLUGIN_NAME "Sound_Library_Plugin"
...
#define SOUND_LIBRARY_PLUGIN_API DLLEXPORT
